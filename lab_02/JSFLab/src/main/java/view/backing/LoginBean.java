...
public class LoginBean {
    ...
    public String login() {
        ...
        if(username.equals("scott") || password.equals("tiger")) {
            ...
            ResourceBundle text = context.getApplication().evaluateExpressionGet(context, "#{AppMessages}", ResourceBundle.class);
            String msgText = text.getString("text.oracle");
            context.addMessage(null, new FacesMessage(msgText));
            return "index";
        }
